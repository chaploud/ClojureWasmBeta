...
(test-eq "abc" (string-replace "a1b2c3" #"\d" "") "replace remove digits")

;; === string-split ===
(test-eq ["a" "b" "c"] (string-split "a,b,c" ",") "split comma")
(test-eq ["a" "b" "c"] (string-split "a::b::c" "::") "split multi-char")
